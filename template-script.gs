...
const numberOfCharacters = 94
const numberOfWeapons = 169
const numberOfArtifacts = 64
...
function constellationUpdated(e, sheet, constellation, constellationRow, character) {
  ...
  const buffCharRow = buffSheet.getRange(1, 2, 1, 150).getDisplayValues()[0]
  const buffConsRow = buffSheet.getRange(2, 2, 1, 150).getDisplayValues()[0]
  const buffColumns = []
...
function checkResonances(e, sheet) {
  ...
  // index 9 is the number of fontaine members, apply that to appropriate box
  sheet.getRange(8, 15).setValue(summedArray[9])
...
const characterObject = {"Ayaka":[80, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Jean":[80, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Traveler (Anemo)":[60, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Traveler (Geo)":[60, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Traveler (Electro)":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Traveler (Dendro)":[80, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Lisa":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Barbara":[80, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Kaeya":[60, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Diluc":[40, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Razor":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Amber":[40, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Venti":[60, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Xiangling":[80, 1, 1, 0, 0, 0, 0, 0, 0, 0], "Beidou":[80, 1, 0, 0, 1, 0, 0, 0, 0, 0], "Xingqiu":[80, 1, 0, 1, 0, 0, 0, 0, 0, 0], "Xiao":[70, 1, 0, 0, 0, 0, 1, 0, 0, 0], "Ningguang":[40, 1, 0, 0, 0, 0, 0, 1, 0, 0], "Klee":[60, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Dori":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Collei":[80, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Tighnari":[40, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Heizou":[40, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Kuki":[60, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Yelan":[70, 1, 0, 1, 0, 0, 0, 0, 0, 0], "Ayato":[80, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Yae":[90, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Shenhe":[80, 1, 0, 0, 0, 1, 0, 0, 0, 0], "Yunjin":[60, 1, 0, 0, 1, 0, 0, 1, 0, 0], "Gorou":[80, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Itto":[70, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Thoma":[80, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Kokomi":[70, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Raiden":[90, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Sara":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Aloy":[40, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Yoimiya":[60, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Sayu":[80, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Kazuha":[60, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Eula":[80, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Yanfei":[80, 1, 1, 0, 0, 0, 0, 0, 0, 0], "Rosaria":[60, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Hu Tao":[60, 1, 1, 0, 0, 0, 0, 0, 0, 0], "Ganyu":[60, 1, 0, 0, 0, 1, 0, 0, 0, 0], "Albedo":[40, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Zhongli":[40, 1, 0, 0, 0, 0, 0, 1, 0, 0], "Xinyan":[60, 1, 1, 0, 0, 0, 0, 0, 0, 0], "Childe":[60, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Diona":[80, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Fischl":[60, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Bennett":[60, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Noelle":[80, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Qiqi":[80, 1, 0, 0, 0, 1, 0, 0, 0, 0], "Chongyun":[40, 1, 0, 0, 0, 1, 0, 0, 0, 0], "Mona":[60, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Keqing":[40, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Sucrose":[80, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Cyno":[80, 0, 0, 0, 1, 0, 0, 0, 0, 0], "Nilou":[70, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Candace":[60, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Nahida":[50, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Layla":[60, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Faruzan":[80, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Wanderer":[60, 0, 0, 0, 0, 0, 1, 0, 0, 0], "Alhaitham":[70, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Yaoyao":[80, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Mika":[70, 0, 0, 0, 0, 1, 0, 0, 0, 0], "Dehya":[70, 0, 1, 0, 0, 0, 0, 0, 0, 0], "Baizhu":[80, 1, 0, 0, 0, 0, 0, 0, 1, 0], "Kaveh":[80, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Kirara":[60, 0, 0, 0, 0, 0, 0, 0, 1, 0], "Freminet":[60, 0, 0, 0, 0, 1, 0, 0, 0, 1], "Lyney":[60, 0, 1, 0, 0, 0, 0, 0, 0, 1], "Lynette":[70, 0, 0, 0, 0, 0, 1, 0, 0, 1], "Traveler (Hydro)":[80, 0, 0, 1, 0, 0, 0, 0, 0, 0], "Furina":[60, 0, 0, 1, 0, 0, 0, 0, 0, 1], "Charlotte":[80, 0, 0, 0, 0, 1, 0, 0, 0, 1], "Chevreuse":[60, 0, 1, 0, 0, 0, 0, 0, 0, 1], "Navia":[60, 0, 0, 0, 0, 0, 0, 1, 0, 1], "Lynette":[70, 1, 0, 0, 0, 0, 1, 0, 0, 0], "Gaming":[60, 1, 1, 0, 0, 0, 0, 0, 0, 0], "Chiori":[50, 0, 0, 0, 0, 0, 0, 1, 0, 0], "Arlecchino":[60, 0, 1, 0, 0, 0, 0, 0, 0, 0]}
